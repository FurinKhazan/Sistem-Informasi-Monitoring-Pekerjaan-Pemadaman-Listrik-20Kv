			  ...
			  <div class="card-body">
					 ...
					 <table class="table">             
		              <tbody>		              
		                ...
		                <tr>
		                	<td  scope="col">Jumlah Trafo GI</td>
		                	<td  scope="col">:</td>
		                 	<td scope="col"><?= $gardu_induk['jml_trafo'];?> TRAFO 60 MVA</td>
		                </tr>
					...
					<?php if (($this->session->userdata('role_id') == '1')) :?>                   
						<a href="<?= base_url();?>gardu_induk"class="btn btn-primary float-right">Kembali</a>
                      <?php endif; ?>      
			  </div>
			</div>
		</div>
